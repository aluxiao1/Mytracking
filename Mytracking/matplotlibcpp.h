...
#else
#include <Python.h>
#endif                                // these scripts are used to avoid debug in debug mode.
...
inline void subplot(long nrows, long ncols, long plot_number)
{
    ...
    // construct positional args
    PyObject* args = PyTuple_New(3);
    // modified for subplot
    // Caller function has arguments of type long in its signature. 
    // Thus, PyLong_FromLong is more appropriate and does not break the code as it was before (runtime_error was being thrown).
